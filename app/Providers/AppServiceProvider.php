...
use App\Policies\MissingItemReportPolicy;
use App\Policies\PackagePolicy;
use App\Policies\ProductPolicy;
use App\Policies\PurchaseOrderPolicy;
use App\Policies\QcCheckPolicy;
use App\Policies\QuickStockOutPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(QuickStockOut::class, QuickStockOutPolicy::class);
        ...
        Gate::policy(MissingItemReport::class, MissingItemReportPolicy::class);
    }
}
