...
use App\Policies\QcTransactionPolicy;
...
use App\Infrastructure\Persistence\Eloquent\Repositories\EloquentQcTransactionRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(QcTransactionRepository::class, EloquentQcTransactionRepository::class);
    ...
    public function boot(): void
    {
        ...
        Gate::policy(QcTransaction::class, QcTransactionPolicy::class);
